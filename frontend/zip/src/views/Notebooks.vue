...
.reader-home {
  ...
  background:
    radial-gradient(circle at 10% 12%, rgba(74, 108, 255, 0.08), transparent 34%),
    radial-gradient(circle at 90% 16%, rgba(24, 198, 184, 0.08), transparent 28%),
    linear-gradient(180deg, #f8faff 0%, #f3f7ff 45%, #eef4ff 100%);
  color: var(--n-text, #171d35);
}
...
.top-search input {
  ...
  font-size: 0.98rem;
  color: #1f2a4e;
  box-shadow: 0 8px 20px rgba(46, 67, 138, 0.07);
}

.top-search input:focus {
  outline: none;
  border-color: #9eb2ff;
  box-shadow: 0 0 0 3px rgba(74, 108, 255, 0.16);
}
...
.limit-pill {
  ...
  border-radius: 999px;
  background: color-mix(in srgb, #4a6cff 10%, #fff);
  color: #294388;
  font-weight: 700;
  padding: 6px 10px;
  font-size: 0.86rem;
...
.clear-btn {
  ...
  border-radius: 10px;
  padding: 7px 12px;
  box-shadow: 0 6px 14px rgba(42, 66, 132, 0.07);
}
...
.book-card {
  border: 1px solid rgba(213, 225, 255, 0.78);
  ...
  box-shadow: 0 10px 22px rgba(32, 54, 110, 0.1);
}

.book-card:hover {
  transform: translateY(-3px);
  border-color: #bdd0ff;
  box-shadow: 0 16px 28px rgba(32, 54, 110, 0.14);
}

.cover {
  height: 224px;
  border-radius: 12px;
  box-shadow: 0 10px 24px rgba(36, 56, 122, 0.12);
  position: relative;
  overflow: hidden;
  border: 1px solid rgba(204, 218, 255, 0.82);
}
